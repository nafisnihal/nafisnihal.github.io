...
export const SectionTitle = styled.h2`
  ...
  line-height: ${(props) => (props.main ? "65px" : "50px")};
  width: max-content;
  max-width: 100%;
  margin-bottom: 16px;
  padding: ${(props) => (props.main ? "30px 0 16px" : "0")};
  ...
  @media ${(props) => props.theme.breakpoints.md} {
    ...
    line-height: ${(props) => (props.main ? "55px" : "45px")};
    margin-bottom: 12px;
    padding: ${(props) => (props.main ? "40px 0 12px" : "0")};
  }
...
export const SectionDivider = styled.div`
  ...
  margin: ${(props) => (props.divider ? "6rem 0 2rem" : "")};

  @media ${(props) => props.theme.breakpoints.lg} {
    width: 48px;
    height: 4px;
    margin: ${(props) => (props.divider ? "4rem 0 2rem" : "")};
  }
...
`;
export const SmAnimation = styled.div`
  display: none;
  @media ${(props) => props.theme.breakpoints.sm} {
    display: block;
    padding: 10px 10px;
